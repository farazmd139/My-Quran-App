...
shareAppLink.addEventListener('click', (e) => { e.preventDefault(); const shareData = { title: 'القرآن الكريم - Faraz AI', text: 'کُرآن پڑھیں، سنئیں اور AI اسسٹنٹ "فراز" سے اسلامی سوالات پوچھیں۔ اس خوبصورت ایپ کو ڈاؤن لوڈ کریں!', url: 'https://play.google.com/store/apps/details?id=com.faraz.quranapp' }; if (navigator.share) { navigator.share(shareData).catch(console.error); } else { alert(shareData.text + "\n" + shareData.url); } });
